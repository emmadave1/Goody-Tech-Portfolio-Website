...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Goody Tech — Creative Designs. Premium Prints. Powerful Brands." },
      { name: "description", content: "Goody Tech is a creative branding, graphic design, and premium printing studio helping businesses stand out." },
      { property: "og:title", content: "Goody Tech — Creative Designs. Premium Prints." },
      { property: "og:description", content: "Branding, graphic design and premium printing that helps businesses stand out." },
